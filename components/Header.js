...
import { unhideAllArticles } from '../reducers/hiddenArticles';
...
function Header() {
	...
	// TODO: display unhide all icon whether user is logged in or not
	let userSection;
	if (user.token) {
		userSection = (
	...
	return (
		<header className={styles.header}>
			<div className={styles.logoContainer}>
				...
				<div>
					{userSection}
					<FontAwesomeIcon className={styles.userSection} onClick={() => handleUnhide()} icon={faEye} />
				</div>
			</div>
